...
?>
        ...
        <nav aria-label="breadcrumb">
           ...
           <li class="breadcrumb-item"><a href="admin_mess_page.php">Mess Page</a></li>
           </ol>
        </nav>
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2">Mess Page</h1>
            <div class="btn-toolbar mb-2 mb-md-0">
              <a class="btn btn-primary" href="add_mess.php">Add Mess Post</a>
            </div>
          </div>
        <!-- table-->
        ...
        <?php
           ...
           $query=mysqli_query($conn,"select mess_info.id,mess_info.post_name,mess_info.area,mess_info.number_seat,mess_info.date 
           from mess_info LEFT JOIN mess_approve ON mess_info.id = mess_approve.mess_id");
         ...
         if($type){
          ...
          <td>
                  <div class="row">
                    <div class="btn-group">
                      <a href="mess_edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fa-solid fa-pen"></i></a>
