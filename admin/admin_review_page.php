...
<style>
  ...
  background-color: #E2E3EC;
    ...
    <?php
     ...
     if ($st_page > 5) 
     {
      echo "<a href='admin_review_page.php?values=3'>First</a>";
      echo "<a href='admin_review_page.php?values=".($st_page-3)."'><<</a>";
    ...
    for ($i=$start_loop;$i <=$end_loop; $i++) 
     { 
        ...
        $hide_values=$i*3;
        echo "<a href='admin_review_page.php?values=".$hide_values."'>".ceil($i)."</a>";
   ...
   if ($__page-1 != $start_loop) 
      {
        echo "<a href='admin_review_page.php?values=".($st_page+3)."'>>></a>";
        echo "<a href='admin_review_page.php?values=".$last_val."'>Last</a>";
      }
    ?>
    </div>
    <br>
