...
?>
        ...
        <?php
           ...
           $query=mysqli_query($conn,"select * from vehicle_info");
         ...
         <tr>
                ...
                <td>
                  <div class="row">
                    <div class="btn-group">
                      <a href="admin_vehicle_edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fa-solid fa-pen"></i></a>
                      <a href="admin_vehicle_delete.php?del=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
                    </div>
