...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        <nav aria-label="breadcrumb">
          ...
          <h1 class="h2">Booking Vehicle page</h1>
        ...
        <form action="booked_vehicle.php" method="post" style="margin:3%;padding:3%" id="flat_form"name="flat_form" enctype="multipart/form-data" >
...
$query=mysqli_query($conn,"INSERT INTO booked_vehicle(name,mobile)VALUES('$name','$mobile')");
