        ...
        <?php
         ...
         <tr>
                ...
                <td>
                  <div class="row">
                    <div class="btn-group">
                      <a href="company_edit.php?edit=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fa-solid fa-pen"></i></a>
                      <a href="company_delete.php?del=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa-solid fa-trash-can"></i></a>
