...
<header>
      <div class="collapse bg-dark" id="navbarHeader">
        <div class="container">
            ...
            $id=$_GET["detail"];
            $query=mysqli_query($conn,"SELECT * FROM flat_book where id='$id'");
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
  ...
  <ul class="list-group list-group-flush">
    ...
    <h6><li class="list-group-item">Family Member:<?php echo $family_member;?></li></h6>
  </ul>
  </div>
    <div class="row" style="margin-left:0.5%; gap:10%;">
       <div class="btn-group" style="10%">
          <a href="accept.php" class="btn btn-success">Accept</a>
