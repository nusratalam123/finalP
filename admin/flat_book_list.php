...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4" style="width:100%">
        ...
        <?php
           ...
           $query=mysqli_query($conn,"select * from flat_book");
         ...
         <tr>
                ...
                <td>
                  <div class="row" style="margin-left:4%;">
                    <div class="btn-group">
                      <a href="flat_book_details.php?detail=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fa-solid fa-arrow-right"></i></a>
                    </div>
