...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4" style="width:100%">
        <nav aria-label="breadcrumb">
          ...
          <h1 class="h2">Mess Booked List</h1>
          </div>
        <!-- table-->
        ...
        <?php
           ...
           $query=mysqli_query($conn,"select * from mess_book");
         ...
         <tr>
                ...
                <td>
                  <div class="row">
                    <div class="btn-group">
                      <a href="mess_book_details.php?detail=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fa-solid fa-arrow-right"></i></a>
                    </div>
                ...
                <td>
                  <div class="row">
                    <div class="btn-group">
                      <a href="mess_book_delete.php?del=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                    </div>
