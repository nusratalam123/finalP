...
?>
        ...
        <nav aria-label="breadcrumb">
          ...
          <h1 class="h2">Available Mess list</h1>
            <div class="btn-toolbar mb-2 mb-md-0" style='gap:10px'>
            <a class="btn btn-primary" href="own_mess.php">Own Post</a>
        ...
        <?php
         ...
         <tr>
                ...
                <td><?php echo $row['cost_room']; ?></td>
                <td>
                  <div class="row">
                    <div class="btn-group">
                      <a href="mess_details.php?detail=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fa-solid fa-arrow-right"></i></a>
                    </div>
