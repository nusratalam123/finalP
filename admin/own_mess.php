...
?>
        ...
        <nav aria-label="breadcrumb">
           ...
           <li class="breadcrumb-item"><a href="own_mess.php">Own Post Page</a></li>
           </ol>
        </nav>
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2">Own Mess Post Page</h1>
        ...
        <?php
           ...
           $query=mysqli_query($conn,"select * from mess_info where email='{$_SESSION['email']}'");
