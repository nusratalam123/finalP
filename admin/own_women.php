...
?>
        ...
        <nav aria-label="breadcrumb">
          ...
          <div class="btn-toolbar" style='gap:10px'>
            ...
            <a class="btn btn-primary" >Own Post</a>
              <a class="btn btn-primary" >Add Women Chef Post</a>
            </div> -->
          </div>
        <!-- table-->
        ...
        <?php
           ...
           $query=mysqli_query($conn,"select * from women_chef_info where email='{$_SESSION['email']}'");
