...
?>
  ...
  <div class="card">
    ...
    <a href="mess_page.php" class="btn btn-primary" style="padding:4%;margin-left:25%">Go here</a>
    </div>
  </div>
  <div class="card">
    <img src="../imagef/flatf.jpg" class="card-img-top" alt="...">
    <div class="card-footer">
    <a href="flat_page.php" class="btn btn-primary" style="padding:4%;margin-left:25%">Go here</a>
    </div>
  </div>
  <div class="card">
    <img src="../admin/image/chef2.jpg" class="card-img-top" alt="...">
    <div class="card-footer">
    <a href="women_chef_page.php" class="btn btn-primary" style="padding:4%;margin-left:25%">Go here</a>
    </div>
  </div>
  <div class="card">
    <img src="../image/truck101.jpg" class="card-img-top" alt="...">
    <div class="card-footer">
    <a href="../admin/vehicle_page.php" class="btn btn-primary" style="padding:4%;margin-left:25%">Go here</a>
    </div>
  </div>
</div>
 <h3 style="padding-top:2%;">Summery of user</h3>         
...
<div class="row">
  <h3 style="padding-top:2%;">Rules and Regulation</h3>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Mess page </h5>
  ...
  <ol class="breadcrumb">
    <h6>finding easily with google map</h6>
  </ol>
</nav>
<h4>Rules</h4>
<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
...
<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Flat Page</h5>
        <nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <h6>Search Flat</h6>
  </ol>
...
<div  style="padding-top:3%;"class="row">
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Chef Page</h5>
        <nav aria-label="breadcrumb">
  <ol class="breadcrumb">
  ...
  <ol class="breadcrumb">
    <h6>Booked vehicle</h6>
  </ol>
  <ol class="breadcrumb">
    <h6>Finding easily with salary range</h6>
  </ol>
</nav>
<h4>Rules</h4>
        <p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
